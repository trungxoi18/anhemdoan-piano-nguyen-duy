<div class="sidebar">
    ...
    <div class="nav-menu">
        ...
        <div class="nav-section-title"><?php echo __('section_inventory'); ?></div>
        <?php if (in_array($_SESSION['role_id'], [1, 2])): ?>
            <a href="hoadon_moi.php" class="nav-item"><span class="material-symbols-rounded">receipt_long</span> <?php echo __('menu_invoice_create'); ?></a>
        <?php endif; ?>
        <a href="phieunhap.php" class="nav-item"><span class="material-symbols-rounded">input</span> <?php echo __('menu_import_slip'); ?></a>
        <a href="phieuxuat.php" class="nav-item"><span class="material-symbols-rounded">output</span> <?php echo __('menu_export_slip'); ?></a>
        <a href="dieuchuyen.php" class="nav-item"><span class="material-symbols-rounded">local_shipping</span> <?php echo __('menu_internal_transfer'); ?></a>
        <a href="baocao_nhapxuatton.php" class="nav-item"><span class="material-symbols-rounded">analytics</span> <?php echo __('menu_inventory_report'); ?></a>
        <a href="tonkho_hientai.php" class="nav-item"><span class="material-symbols-rounded">inventory</span> <?php echo __('menu_current_stock'); ?></a>
        <?php endif; ?>
        ...
        <a href="quanly_baotri.php" class="nav-item"><span class="material-symbols-rounded">build</span> <?php echo __('menu_maintenance'); ?></a>
